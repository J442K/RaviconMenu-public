...
namespace YimMenu::Submenus
{
	...
	auto weaponsFunGroup     = std::make_shared<Group>("Fun");
	...
	weaponsFunGroup->AddItem(std::make_shared<BoolCommandItem>("explosivebullets"_J));
	weaponsFunGroup->AddItem(std::make_shared<ConditionalItem>("explosivebullets"_J, std::make_shared<ListCommandItem>("bullettype"_J)));
	// Firefly Bullets (Molotov bullets)
	weaponsFunGroup->AddItem(std::make_shared<BoolCommandItem>("fireflybullets"_J, "Firefly Bullets"));

	weapons->AddItem(weaponsGlobalsGroup);
	weapons->AddItem(weaponsFunGroup);
